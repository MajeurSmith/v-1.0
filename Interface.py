...
#Connexion des villes :
    win0.Dunkerque.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Lille.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Amiens.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Cherbourg.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Rouen.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Caen.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Le_Havre.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Paris.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Reims.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Nancy.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Strasbourg.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Rennes.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Orleans.clicked.connect(lambda  : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Nantes.clicked.connect(lambda  : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Poitiers.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Dijon.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Limoges.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Lyon.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Clermont_Ferrand.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Bordeaux.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Toulouse.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Montpellier.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.Marseille.clicked.connect(lambda : aeroport(str("Marseille Provence Airport")))
    win0.Ajaccio.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.La_Guadeloupe.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.La_Guyane.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.La_Martinique.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
    win0.La_Reunion.clicked.connect(lambda : aeroport(str("TROUVER LES NOMS DES AEROPORTS")))
